...
public class TableroModeloLogico {
    ...
    public Jugador getJugadorActual() { 
        if (jugadores.isEmpty() || jugadorActualIdx == -1) return null; // CORREGIDO
        return jugadores.get(jugadorActualIdx); 
    }
    public int getJugadorActualIdx() { return jugadorActualIdx; }
    public int[] getPuntajes() { return puntajes.clone(); }
    public int[][] getCuadrados() { return cuadrados.clone(); }
    public int[][] getLineasHorizontales() { return lineasHorizontales.clone(); }
    public int[][] getLineasVerticales() { return lineasVerticales.clone(); }
    public int getTotalCuadrados() { return totalCuadrados; }
    public int getCuadradosCompletados() { return cuadradosCompletados; }
    public boolean isJuegoTerminado() { return cuadradosCompletados == totalCuadrados && totalCuadrados > 0; }
